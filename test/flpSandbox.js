		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#projetonetfix-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projetonetfix-display": {
								"semanticObject": "projetonetfix",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projetonetfix",
									"url": sap.ui.require.toUrl("projetonetfix")
								}
							}
						}
					}
